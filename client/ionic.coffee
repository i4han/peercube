...
ion.add cube.Parts ->
   ...
   ionItemLabelBarstar: (_, label, attr, l, r) -> ionic.Item(_, @ionLabel(_, label), @ionRange(_, __.object(attr, 'class', 'barstar'), l, r), ionic.Icon(_, class: 'sstar ion-android-star'))
   ionItemLabelRange:  (_, label, attr, l, r, star) -> ionic.Item _, @ionLabel(_, label), @ionRange(_, __.object(attr, 'class', 'bstar'), l, r), if star then ionic.Icon(_, class: 'sstar ion-android-star') else ''
